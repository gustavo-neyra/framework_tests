...
public class MetodosGenericos {
    ...
    public static void waitExplicitClickeable(WebElement elementName, int time) {
        try {
            System.out.println("Esperando elemento");
            WebDriverWait myWaitVar = new WebDriverWait(DriverContext.getDriver(), Duration.ofSeconds(time));
    ...
    public static void cambiarUrl(String url) {
        try {
            ...
            System.out.println("Se reintenta conexión");
            try {
                DriverContext.getDriver().get(url);
            } catch (org.openqa.selenium.TimeoutException e1) {
                System.out.println("Se reintenta conexión por 2da vez");
                try{
                    DriverContext.getDriver().get(url);
                }catch (org.openqa.selenium.TimeoutException e2){
                    System.out.println("Se reintenta conexión por 3ra vez");
                    DriverContext.getDriver().get(url);
                }
            }
        }
    ...
    public static void msgContieneTexto(WebElement element, String mensaje) {
        try {
            MetodosGenericos.esperar(30);
            String dato = element.getText();
    ...
    public static WebElement buscarElemento(String rutaXpath) {
        By webElement = By.xpath(rutaXpath);
        waitExplicit(DriverContext.getDriver().findElement(webElement), 5);
        return DriverContext.getDriver().findElement(webElement);
    }

	public static List<WebElement> buscarElementos(String rutaXpath){
		By webElement = By.xpath(rutaXpath);
		MetodosGenericos.esperar(5);
		waitExplicit(DriverContext.getDriver().findElement(webElement),50);
		return DriverContext.getDriver().findElements(webElement);
	}
